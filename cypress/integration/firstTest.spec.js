...
describe('Our fist suite', ()=>{
    ...
    it('first test', ()=>{
        ...
        //by tag name, attribute, ID and class name
    ...
    it('Web Tables', ()=>{
        ...
        cy.wait(1000)
        cy.get('tbody tr').each ( tablerRow =>{
            if(age==200){
                cy.wrap(tablerRow).should('contain','No data found')
            }
            else{
                cy.wrap(tablerRow).find('td').eq(6).should('contain',age)
            }
